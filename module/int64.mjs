...
// أضف هذا الكود في نهاية الملف تماماً بدلاً من السطور الأخيرة
export { Int as Int64 }; // للتوافق مع الاستيراد المسمى { Int64 }
export default Int;      // للتوافق مع الاستيراد الافتراضي (وهو ما يطلبه الخطأ الحالي)
